...
/**
 * iCloud Email Provider
 * 
 * Implementation of the email provider interface for iCloud accounts.
 * Uses IMAP for receiving mail and SMTP for sending.
 */
export class ICloudProvider extends BaseEmailProvider {
